...
- Verified states: 1158 × 950 locked-reference desktop, 1440 × 1000 desktop, 768 × 1024 tablet, 390 × 844 mobile, reduced motion, and Product before optional 3D activation.
...
- `output/playwright/after/overnight-home-desktop-1440.png`
- `output/playwright/after/overnight-home-tablet-768.png`
- `output/playwright/after/overnight-home-mobile-390.png`
- `output/playwright/after/overnight-home-reduced-motion.png`
- `output/playwright/after/overnight-product-before-spline.png`
...
- Chrome route QA found one H1, `noindex, nofollow, noarchive`, no canonical, no form, no enabled personal-data controls, and zero horizontal overflow on every checked public route.
- Initial and reduced-motion traversal produced zero requests to Spline or unpkg. The optional 3D load control remains available only in normal motion and was not activated during the pre-Spline capture.
- The exact owner-supplied logo SHA-256 remains `FB25E522D8F96B54A55EA421241215DAFD16069279AC576F3BF2126B2BEF0276`.
