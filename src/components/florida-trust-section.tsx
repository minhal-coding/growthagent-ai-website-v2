...
export function FloridaTrustSection() {
  return (
    <section aria-labelledby="florida-trust-title" className="relative overflow-hidden border-y border-white/10 bg-[#06090f] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-[90rem]">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 id="florida-trust-title" className="mt-5 text-balance text-4xl font-extrabold leading-[1.02] tracking-[-0.05em] text-white sm:text-6xl lg:text-7xl">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">
            Florida construction is the planned first market. Every location, connection, and validation topic below is illustrative—not evidence of active coverage.
          </p>
          <p className="mx-auto mt-6 inline-flex max-w-3xl items-center gap-2 rounded-full border border-[#e4bd45]/40 bg-[#e4bd45]/[0.07] px-4 py-2 text-sm font-extrabold text-[#f6d665]">
        ...
        <div className="mt-12 overflow-hidden rounded-[1.6rem] border border-white/12 bg-[#070b12]/94 shadow-[0_38px_110px_rgba(0,0,0,0.36)]">
          <div className="grid xl:grid-cols-[1.08fr_0.92fr]">
            <div className="relative min-h-[34rem] overflow-hidden border-b border-white/10 p-5 xl:border-b-0 xl:border-r sm:p-8">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_40%_44%,rgba(66,214,199,0.12),transparent_38%)]" aria-hidden="true" />
              <div className="absolute left-5 top-5 z-10 sm:left-8 sm:top-8">
                ...
                <p className="mt-2 max-w-xs text-sm leading-6 text-slate-400">Generic research areas connected for demonstration. No county or source is shown as live.</p>
              </div>

              <Image
                src="/florida-validation-map.png"
                alt="Illustrative Florida validation map with generic connected research areas; not active coverage"
                fill
              ...
              <div className="absolute inset-x-5 bottom-5 z-10 grid gap-2 sm:inset-x-8 sm:bottom-8 sm:grid-cols-2">
                {launchAreas.map((area) => (
                  <div key={area} className="flex items-center gap-2.5 rounded-xl border border-white/10 bg-[#05070d]/88 px-3 py-2.5 text-xs font-semibold text-slate-200 backdrop-blur-md">
